...
export default function MessageTextarea({ onSubmit }: Props) {
    ...
    return (
        <div
            ref={containerRef}
            className="fixed bottom-0 left-0 right-0 flex w-full flex-row gap-5 border-t-2 border-t-primary-100 bg-layout-light py-2.5 pl-2.5 pr-5 dark:border-t-primary-950 dark:bg-layout-dark"
        >
            <textarea
                ref={textareaRef}
                value={message}
