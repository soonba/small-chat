...
export type JoinMutation = {
    __typename?: 'Mutation';
    join: { __typename?: 'JoinResponse'; userId: string; nickname: string };
};
...
export type CreateRoomMutation = {
    __typename?: 'Mutation';
    createRoom: { __typename?: 'CreateRoomResponse'; roomId: string };
};
...
export type SubscribeRoomSubscription = {
    __typename?: 'Subscription';
    subscribeRoom: {
        __typename?: 'MessageResponse';
        messageId: string;
        ...
        message: string;
        createdAt: any;
        sender: { __typename?: 'Sender'; userId: string; nickname: string };
    };
};
...
export type GetMyChattingListQuery = {
    __typename?: 'Query';
    getMyChattingList: {
        __typename?: 'MyRoomsResponse';
        participationRooms: Array<{ __typename?: 'ParticipationRoom'; roomId: string; roomName: string }>;
    };
};
...
export type GetRoomLatestInfosQuery = {
    __typename?: 'Query';
    getRoomLatestInfos: Array<{
        __typename?: 'RoomResponse';
        roomId: string;
        lastMessage: string;
...
export type JoinRoomMutation = {
    __typename?: 'Mutation';
    joinRoom: { __typename?: 'GeneralResponse'; message: string };
};
...
export type GetHistoryByRoomIdQuery = {
    __typename?: 'Query';
    getHistoryByRoomId: {
        __typename?: 'MessageHistoryResponse';
        messages: Array<{
 ...
 * });
 */
export function useSubscribeRoomSubscription(
    baseOptions: Apollo.SubscriptionHookOptions<SubscribeRoomSubscription, SubscribeRoomSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<SubscribeRoomSubscription, SubscribeRoomSubscriptionVariables>(
        SubscribeRoomDocument,
        options
    );
}
 ...
 * });
 */
export function useGetMyChattingListQuery(
    baseOptions: Apollo.QueryHookOptions<GetMyChattingListQuery, GetMyChattingListQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetMyChattingListQuery, GetMyChattingListQueryVariables>(GetMyChattingListDocument, options);
}
export function useGetMyChattingListLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetMyChattingListQuery, GetMyChattingListQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<GetMyChattingListQuery, GetMyChattingListQueryVariables>(
        GetMyChattingListDocument,
        options
    );
}
 ...
 * });
 */
export function useGetRoomDetailsQuery(
    baseOptions: Apollo.QueryHookOptions<GetRoomDetailsQuery, GetRoomDetailsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetRoomDetailsQuery, GetRoomDetailsQueryVariables>(GetRoomDetailsDocument, options);
}
export function useGetRoomDetailsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetRoomDetailsQuery, GetRoomDetailsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useGetRoomLatestInfosQuery(
    baseOptions: Apollo.QueryHookOptions<GetRoomLatestInfosQuery, GetRoomLatestInfosQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetRoomLatestInfosQuery, GetRoomLatestInfosQueryVariables>(
        GetRoomLatestInfosDocument,
        options
    );
}
export function useGetRoomLatestInfosLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetRoomLatestInfosQuery, GetRoomLatestInfosQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<GetRoomLatestInfosQuery, GetRoomLatestInfosQueryVariables>(
        GetRoomLatestInfosDocument,
        options
    );
}
...
export type GetRoomLatestInfosQueryResult = Apollo.QueryResult<
    GetRoomLatestInfosQuery,
    GetRoomLatestInfosQueryVariables
>;
...
export function useJoinRoomMutation(
    baseOptions?: Apollo.MutationHookOptions<JoinRoomMutation, JoinRoomMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
 ...
 * });
 */
export function useGetHistoryByRoomIdQuery(
    baseOptions: Apollo.QueryHookOptions<GetHistoryByRoomIdQuery, GetHistoryByRoomIdQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetHistoryByRoomIdQuery, GetHistoryByRoomIdQueryVariables>(
        GetHistoryByRoomIdDocument,
        options
    );
}
export function useGetHistoryByRoomIdLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetHistoryByRoomIdQuery, GetHistoryByRoomIdQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useLazyQuery<GetHistoryByRoomIdQuery, GetHistoryByRoomIdQueryVariables>(
        GetHistoryByRoomIdDocument,
        options
    );
}
...
export type GetHistoryByRoomIdQueryResult = Apollo.QueryResult<
    GetHistoryByRoomIdQuery,
    GetHistoryByRoomIdQueryVariables
>;
