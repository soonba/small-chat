...
export default function Typography() {
  return (
    <div>
      ...
      <div className="w-full space-y-10 rounded">
        <div className="flex w-full flex-col items-start justify-between gap-y-10 md:flex-row md:flex-wrap">
          <div className="flex-1 space-y-5">
            <div className="flex flex-1 items-center gap-x-2.5">
              <h3 className="text-16-B-24 text-black">System Font</h3>
              <Link
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <div className="flex flex-1 items-center gap-2.5">
                <small className="mr-2.5 mt-auto text-gray-900">ENG</small>
                <h4 className="flex-1 text-16-B-24 md:text-30-B-36">Pretendard</h4>
              </div>
              <div className="flex flex-1 items-center gap-2.5">
                <small className="mr-2.5 mt-auto text-gray-900">KOR</small>
              ...
              {['font-light', 'font-regular', 'font-medium', 'font-semibold', 'font-bold', 'font-black'].map(
                (fontWeight) => (
                  <p key={fontWeight} className="flex items-center gap-5 text-14-R-20 md:text-18-R-28">
                    <span className={`${fontWeight} w-24 capitalize text-black`}>{fontWeight.split('-')[1]}</span>
          ...
          <div className="flex-1 space-y-5 text-left">
            <div className="flex items-center gap-x-2.5 font-jua">
              <h3 className="text-16-B-24 text-black">Title Font</h3>
              <Link
                rel="noopener noreferrer"
                target="_blank"
                title="Jua Font"
        ...
        <div className="flex flex-wrap items-start justify-between gap-5">
          {[
            ...
            <div key={data.name} className="flex-1 text-left">
              <h3 className="mb-5 text-16-B-24 text-black">{data.name}</h3>
              <ul className="space-y-5">
                {data.list.map((variant) => (
                  ...
                  >
                    <p className="flex w-full shrink-0 flex-col gap-1 text-16-SB-24 text-gray-900 md:w-28">
