...
// TODO: Remove Dummy
export default function ChatListItem({ onClick }: ChatListItemType) {
    return (
        <li className="group rounded-md border border-blue-gray-100 bg-white p-2.5 hover:bg-blue-gray-50/50">
            <button type="button" className="block h-full w-full" onClick={() => onClick('testid')}>
                <div className="flex items-center gap-x-2">
                    ...
                    <div className="relative h-14 w-full">
                        <div className="my-1 flex w-full items-start justify-between">
                            <p className="w-32 truncate text-base font-bold group-hover:text-blue-gray-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
