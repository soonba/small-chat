...
export type GetMyChattingListQuery = {
    __typename?: 'Query';
    getMyChattingList: { __typename?: 'MyRoomsResponse'; participationRooms: Array<{ __typename?: 'ParticipationRoom'; roomId: string; roomName: string }> };
};
...
export type GetRoomDetailsQuery = {
    __typename?: 'Query';
    getRoomDetails: { __typename?: 'RoomInfoResponse'; roomId: string; roomName: string; messages: Array<{ __typename?: 'MessageResponse'; roomId: string; sender: string; message: string }> };
};
